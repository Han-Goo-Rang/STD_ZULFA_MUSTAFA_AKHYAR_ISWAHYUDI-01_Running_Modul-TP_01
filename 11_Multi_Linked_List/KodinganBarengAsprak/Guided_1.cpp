...
int main()
{
    ...
    infotype m2 = {"Bobi", "01", 'L', 3.71};
    infotype m3 = {"Cindi", "01", 'P', 3.5};
    infotype m4 = {"Danu", "01", 'L', 4.0};
    infotype m5 = {"Eli", "01", 'P', 3.4};
    infotype m6 = {"Fahmi", "01", 'L', 3.45};
    infotype m7 = {"Gita", "01", 'P', 3.75};
    infotype m8 = {"Hilmi", "01", 'L', 3.3};
